...
type Props = {
  ...
  disabled?: boolean;
  placeholder?: string;
  loadMoreOptions?: () => void; // New prop to handle "Load More"
  hasMore?: boolean; // New prop to indicate if more options are available
};
          ...
          <div className="relative">
            <Combobox.Input
              className={classNames(
                "w-full rounded-[8px]  placeholder:text-sm text-sm border-0 bg-white py-2.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset light:focus:ring-2 light:focus:ring-inset focus:outline-none sm:leading-6  ring-typography-secondary/30",
                error
            ...
            >
              <ChevronDownIcon
                className={`${
                  open ? "" : ""
                } h-5 w-5 text-typography-secondary/30 duration-300`}
                aria-hidden="true"
              />
            </Combobox.Button>
                ...
                {hasMore && (
                  <div className=" text-center">
                    <button
                      ...
                      className="text-sm py-1 text-typography-primary-light  w-full bg-typography-secondary-light hover:bg-typography-secondary-light/80"
                    >
                      Load More
                    </button>
                  </div>
