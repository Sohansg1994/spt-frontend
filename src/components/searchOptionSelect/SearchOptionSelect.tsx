      ...
      >
        {() => (
          <div className="relative">
            ...
            {!disabled && (
              <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-surface text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                {isLoading ? (
                  <div className="flex items-center justify-center py-2">
                    <svg
                      className="animate-spin h-5 w-5 text-primary-900 bg-surface "
                  ...
                  filteredOptions.map((option) => (
                    <div key={option.id}>
                      {option.children ? (
                        <div>
                          <div className="bg-su px-3 py-2 font-semibold z-50 ">
                            {option.name}
                          </div>
                          <div>
